...
namespace AprioriSite.Infrasructure.Migrations
{
    ...
    [Migration("20220328075707_ApplicationUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AprioriSite.Infrasructure.Data.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AprioriSite.Infrasructure.Data.Item", b =>
                {
                    b.HasOne("AprioriSite.Infrasructure.Data.Category", "Category")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AprioriSite.Infrasructure.Data.Identity.ApplicationUser", null)
                        .WithMany()
